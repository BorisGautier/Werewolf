...
function registerDonationCommands(bot: Bot, env: Env, deps: BotDependencies): void {
  ...
  void bot.api
    .setMyCommands([
      ...
      { command: 'botgame', description: '🤖 Jouer immédiatement avec des IA Gemini 2.5' },
      { command: 'startchaos', description: '🌀 Lancer une partie en mode Chaos' },
      { command: 'join', description: '✋ Rejoindre la partie en attente' },
      { command: 'forcestart', description: '⚡ Lancer la partie sans attendre le timer' },
      ...
      { command: 'help', description: "❓ Obtenir de l'aide et la liste des règles" },
