...
export const WEATHER_DETAILS: Record<VillageWeather, WeatherInfo> = {
  ...
  FullMoon: {
    ...
    descFr: 'La lune brille d\'une clarté surnaturelle... L\'énergie des Loups et des créatures de la nuit est décuplée !',
    descEn: 'The moon shines with supernatural clarity... The energy of wolves and night creatures surges!',
  },
  ThickFog: {
    type: 'ThickFog',
    emoji: '🌫️',
    ...
    descFr: 'Un brouillard dense s\'étend sur Thiercelieux. Les silhouettes s\'estompent dans l\'ombre...',
  ...
  Eclipse: {
    ...
    descFr: 'Une éclipse mystique plonge le village dans le secret... Les votes de lynchage restent anonymes !',
  ...
  Thunderstorm: {
    ...
    descFr: 'Le vent hurle et les éclairs fendent la nuit ! Les nuits et les jours s\'enchaînent à toute vitesse.',
