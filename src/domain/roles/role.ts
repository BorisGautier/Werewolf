...
export const ROLE_META: Record<RoleName, RoleMeta> = {
  ...
  Watchman: { emoji: '🔦', canBeDisabled: true },
  Judge: { emoji: '⚖️', canBeDisabled: true },
  Archivist: { emoji: '📜', canBeDisabled: true },
  Tracker: { emoji: '🐕', canBeDisabled: true },
  Priestess: { emoji: '🕯️', canBeDisabled: true },
  Mimic: { emoji: '🥸', canBeDisabled: true },
  CrownPrince: { emoji: '🤴', canBeDisabled: true },
  Archangel: { emoji: '👼⚡️', canBeDisabled: true },
  TrapperWolf: { emoji: '🐺🕸️', canBeDisabled: true },
  ChameleonWolf: { emoji: '🐺🎭', canBeDisabled: true },
  ViperWolf: { emoji: '🐺🧪', canBeDisabled: true },
  HowlerWolf: { emoji: '🐺📣', canBeDisabled: true },
  HypnotistWolf: { emoji: '🐺🧠', canBeDisabled: true },
  BerserkerWolf: { emoji: '🐺💢', canBeDisabled: true },
  Necromancer: { emoji: '🧙‍♂️', canBeDisabled: true },
  Jester: { emoji: '🤡', canBeDisabled: true },
  Hitman: { emoji: '🗡️', canBeDisabled: true },
  Reflector: { emoji: '🪞', canBeDisabled: true },
  Avenger: { emoji: '💀', canBeDisabled: true },
  Crow: { emoji: '🐦‍⬛', canBeDisabled: true },
};
