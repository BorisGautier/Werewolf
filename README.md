...
du projet original Werewolf for Telegram (C# / .NET Framework),
pensée pour tourner en un seul service Docker sur un VPS personnel.

> Ce dépôt contient le port complet, à la racine. Le projet C# original vit
> dans [`legacy-csharp/`](./legacy-csharp/) et n'est conservé que comme
> référence historique — il n'est plus déployé.
